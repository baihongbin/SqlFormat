    ...
    static class Program
    {
        ...
        static void Main()
        {
            try
            {
                ...
                if (!isAppRunning)
                {
                    MessageBox.Show("程序已运行，不能再次打开！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    Environment.Exit(1);
                }
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("程序发生错误，请及时联系作者！", "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
