...
namespace BaiSqlFormatLib.Parsers
{
    public class TSqlStandardParser : ISqlTokenParser
    {
        ...
        private static bool IsStatementStarter(IToken token)
        {
            ...
            return (token.Type == SqlTokenType.OtherNode
                && (uppercaseValue.Equals("ALTER")
                    ...
                    //|| uppercaseValue.Equals("IF")  sql中的if不换行
                    ...
                    //添加 hive 建表中的关键字 换行
                    || uppercaseValue.Equals("PARTITIONED") 
                    || uppercaseValue.Equals("STORED")
                    || uppercaseValue.Equals("TBLPROPERTIES")
                    )
                );
        }
        ...
        private static void InitializeKeywordList()
        {
            ...
            KeywordList.Add("COMMENT", KeywordType.FunctionKeyword);
            ...
            KeywordList.Add("DEFAULT", KeywordType.FunctionKeyword);
            ...
            KeywordList.Add("NVL", KeywordType.OtherKeyword);
            ...
            KeywordList.Add("STRING", KeywordType.DataTypeKeyword);
            ...
            //添加 hive 中的建表关键字
            KeywordList.Add("OVERWRITE", KeywordType.OtherKeyword);
            KeywordList.Add("PARTITIONED", KeywordType.OtherKeyword);
            KeywordList.Add("STORED", KeywordType.OtherKeyword);
            KeywordList.Add("TBLPROPERTIES", KeywordType.OtherKeyword);
